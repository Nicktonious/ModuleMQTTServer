...
var C = {
  ...
  class MQTT {
    constructor() {
        ...
        this._Proxy = new (require('ModuleProxyMQTT.min.js'))(this);
        this.AddSubs(options.subs);
    }
    AddSubs(subsObj) {
        for (let service of Object.keys(subsObj)) {
            this._Proxy.AddSubs(service, subsObj[service]);
        }
    }
